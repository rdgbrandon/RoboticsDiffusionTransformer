...
for episode in tqdm.trange(total_episodes):
    ...
    while global_steps < MAX_EPISODE_STEPS and not done:
        ...
        actions.squeeze(0).cpu().numpy(), raw_actions = policy.info_step(proprio, images, text_embed)

        # NOTE: ADD INTEGRATED GRADIENTS HERE
        
        #naive
        first_joint_raw = raw_actions
    ...
    print(f"Trial {episode+1} finished, success: {info['success']}, steps: {global_steps}, raw action {raw_action}")
